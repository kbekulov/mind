...
The initial personal documents are editable examples and research frameworks. The separate **Job observatory** (`#view=market`) contains real sourced research: 36 vacancy advertisements across 17 European and Asian countries, checked on 23 September 2026. All seniority levels and work arrangements are in scope.
